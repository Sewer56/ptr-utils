...
pub trait UnalignedWrite {
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for writing 1 byte
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for writing 2 bytes
    /// - The caller must ensure the pointer remains valid for the duration of the write
    /// - The memory location must be mutable
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for writing 4 bytes
    /// - The caller must ensure the pointer remains valid for the duration of the write
    /// - The memory location must be mutable
    /// - No alignment requirements - this performs unaligned writes
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for writing 8 bytes
    /// - The caller must ensure the pointer remains valid for the duration of the write
    /// - The memory location must be mutable
    /// - No alignment requirements - this performs unaligned writes
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for writing 16 bytes
    /// - The caller must ensure the pointer remains valid for the duration of the write
    /// - The memory location must be mutable
    /// - No alignment requirements - this performs unaligned writes
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for writing [`size_of::<usize>()`] bytes
    /// - The caller must ensure the pointer remains valid for the duration of the write
    /// - The memory location must be mutable
    /// - No alignment requirements - this performs unaligned writes
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for writing [`size_of::<isize>()`] bytes
    /// - The caller must ensure the pointer remains valid for the duration of the write
    /// - The memory location must be mutable
    /// - No alignment requirements - this performs unaligned writes
...
impl<T> UnalignedWrite for *mut T {
    #[inline(always)]
    unsafe fn write_u8_at(self, offset: usize, value: u8) {
        (self as *mut u8).add(offset).write_unaligned(value);
    }
    ...
    #[inline(always)]
    unsafe fn write_u64_at(self, offset: usize, value: u64) {
        ((self as *mut u8).add(offset) as *mut u64).write_unaligned(value);
    }

    #[inline(always)]
    unsafe fn write_u128_at(self, offset: usize, value: u128) {
        ((self as *mut u8).add(offset) as *mut u128).write_unaligned(value);
    }

    #[inline(always)]
    unsafe fn write_usize_at(self, offset: usize, value: usize) {
        ((self as *mut u8).add(offset) as *mut usize).write_unaligned(value);
    }

    #[inline(always)]
    unsafe fn write_i8_at(self, offset: usize, value: i8) {
        ((self as *mut u8).add(offset) as *mut i8).write_unaligned(value);
    }

    #[inline(always)]
    unsafe fn write_i16_at(self, offset: usize, value: i16) {
        ((self as *mut u8).add(offset) as *mut i16).write_unaligned(value);
    }

    #[inline(always)]
    unsafe fn write_i32_at(self, offset: usize, value: i32) {
        ((self as *mut u8).add(offset) as *mut i32).write_unaligned(value);
    }

    #[inline(always)]
    unsafe fn write_i64_at(self, offset: usize, value: i64) {
        ((self as *mut u8).add(offset) as *mut i64).write_unaligned(value);
    }

    #[inline(always)]
    unsafe fn write_i128_at(self, offset: usize, value: i128) {
        ((self as *mut u8).add(offset) as *mut i128).write_unaligned(value);
    }

    #[inline(always)]
    unsafe fn write_isize_at(self, offset: usize, value: isize) {
        ((self as *mut u8).add(offset) as *mut isize).write_unaligned(value);
    }

    #[inline(always)]
    unsafe fn write_f32_at(self, offset: usize, value: f32) {
        ((self as *mut u8).add(offset) as *mut f32).write_unaligned(value);
    }

    #[inline(always)]
    unsafe fn write_f64_at(self, offset: usize, value: f64) {
        ((self as *mut u8).add(offset) as *mut f64).write_unaligned(value);
    }

    #[inline(always)]
    unsafe fn write_bool_at(self, offset: usize, value: bool) {
        ((self as *mut u8).add(offset) as *mut bool).write_unaligned(value);
    }
}
