...
pub trait UnalignedRead {
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for reading 1 byte
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for reading 2 bytes
    /// - The caller must ensure the pointer remains valid for the duration of the read
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for reading 4 bytes
    /// - The caller must ensure the pointer remains valid for the duration of the read
    /// - No alignment requirements - this performs unaligned reads
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for reading 8 bytes
    /// - The caller must ensure the pointer remains valid for the duration of the read
    /// - No alignment requirements - this performs unaligned reads
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for reading 16 bytes
    /// - The caller must ensure the pointer remains valid for the duration of the read
    /// - No alignment requirements - this performs unaligned reads
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for reading [`size_of::<usize>()`] bytes
    /// - The caller must ensure the pointer remains valid for the duration of the read
    /// - No alignment requirements - this performs unaligned reads
    ...
    ///
    /// # Safety
    /// - The pointer plus offset must be valid for reading [`size_of::<isize>()`] bytes
    /// - The caller must ensure the pointer remains valid for the duration of the read
    /// - No alignment requirements - this performs unaligned reads
...
impl<T> UnalignedRead for *const T {
    #[inline(always)]
    unsafe fn read_u8_at(self, offset: usize) -> u8 {
        (self as *const u8).add(offset).read_unaligned()
    }
    ...
    #[inline(always)]
    unsafe fn read_u64_at(self, offset: usize) -> u64 {
        ((self as *const u8).add(offset) as *const u64).read_unaligned()
    }
    
    #[inline(always)]
    unsafe fn read_u128_at(self, offset: usize) -> u128 {
        ((self as *const u8).add(offset) as *const u128).read_unaligned()
    }
    
    #[inline(always)]
    unsafe fn read_usize_at(self, offset: usize) -> usize {
        ((self as *const u8).add(offset) as *const usize).read_unaligned()
    }
    
    #[inline(always)]
    unsafe fn read_i8_at(self, offset: usize) -> i8 {
        ((self as *const u8).add(offset) as *const i8).read_unaligned()
    }
    
    #[inline(always)]
    unsafe fn read_i16_at(self, offset: usize) -> i16 {
        ((self as *const u8).add(offset) as *const i16).read_unaligned()
    }
    
    #[inline(always)]
    unsafe fn read_i32_at(self, offset: usize) -> i32 {
        ((self as *const u8).add(offset) as *const i32).read_unaligned()
    }
    
    #[inline(always)]
    unsafe fn read_i64_at(self, offset: usize) -> i64 {
        ((self as *const u8).add(offset) as *const i64).read_unaligned()
    }
    
    #[inline(always)]
    unsafe fn read_i128_at(self, offset: usize) -> i128 {
        ((self as *const u8).add(offset) as *const i128).read_unaligned()
    }
    
    #[inline(always)]
    unsafe fn read_isize_at(self, offset: usize) -> isize {
        ((self as *const u8).add(offset) as *const isize).read_unaligned()
    }
    
    #[inline(always)]
    unsafe fn read_f32_at(self, offset: usize) -> f32 {
        ((self as *const u8).add(offset) as *const f32).read_unaligned()
    }
    
    #[inline(always)]
    unsafe fn read_f64_at(self, offset: usize) -> f64 {
        ((self as *const u8).add(offset) as *const f64).read_unaligned()
    }
    
    #[inline(always)]
    unsafe fn read_bool_at(self, offset: usize) -> bool {
        ((self as *const u8).add(offset) as *const bool).read_unaligned()
    }
}
